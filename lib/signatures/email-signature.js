export const getEmailSignature = (
    logoUrl = process.env.NEXT_PUBLIC_SITE_URL + '/images/logo-3.svg'
) => {
    return `
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td style="width: 60px; padding-right: 15px; vertical-align: top;">
                            <img 
                                src="${logoUrl}" 
                                alt="Sajaavat Events - Bespoke Wedding & Event Decor" 
                        ...
                        <td style="vertical-align: top;">
                            ...
                            <p style="color: #e8e1e1; margin: 0 0 10px; font-size: 12px; font-style: italic;">
                                Bespoke Wedding & Event Decor Specialists
                            </p>
                            <p style="margin: 0; font-size: 13px; line-height: 1.6; color: #e8e1e1;">
                                Coventry & UK Wide<br>
                                <a href="mailto:info@sajaavat.co.uk" style="color: #e8e1e1; text-decoration: none;">
                                    ✉️ info@sajaavat.co.uk
                                </a><br>
                                <a href="https://www.sajaavat.co.uk" style="color: #e8e1e1; text-decoration: none;">
                                    🌐 www.sajaavat.co.uk
                                </a>
                            </p>
                        </td>
